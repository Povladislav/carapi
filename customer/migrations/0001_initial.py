    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateField(auto_now=True)),
                ('updated_at', models.DateField(auto_now_add=True)),
                ('email', models.EmailField(db_index=True, max_length=44, unique=True)),
                ('balance', models.DecimalField(decimal_places=0, max_digits=6, null=True, validators=[django.core.validators.MinValueValidator(0)])),
